...
fid = fopen('.\output\Etma_cca_ranked_variables.txt','wt');

v_cols = 1:45;

% Print Header
% disp(['VRmethod, DataType, Normalisation, includeEmptyValues, ' ...
...
for w_n = 0:2
    ...
    for rank_type = vCCArankTypes
        ...
        v_ranks = num2str(vbincentrs(I(1:45)),',%4.4f')';
        v_ranks = v_ranks(:)';
...
%         disp([curDataParams.classificationMethod ',' ...
%             curDataParams.dataType ',' ...
%             num2str(curDataParams.normalisation) ',' ...
%             num2str(curDataParams.includeEmptyVals) ',' ...
%             num2str(curDataParams.smoothParam) ',' ...
