...
%                           4.  Should not include '.ps', or this will
%                                   appear twice in file names
...
%    Copyright (c) J. S. Marron 1998-2012
...
if nargin > 1 ;   %  then paramstruct is an argument
  ...
  if isfield(paramstruct,'iaxlim') ;    %  then change to input value
    iaxlim = getfield(paramstruct,'iaxlim') ; 
  end ;
...
if vipageout(3) == 1 ;
  ...
  paramstruct3 = struct('icolor',icolor, ...
                        ...
                        'savestr',savestr3) ;
  if ~(isempty(legendcellstr)) ;
    paramstruct3 = setfield(paramstruct3,'legendcellstr',legendcellstr) ;
  end ;
  if ~(isempty(mlegendcolor)) ;
    paramstruct3 = setfield(paramstruct3,'mlegendcolor',mlegendcolor) ;
  end ;
