...
if ( augmentWithUserData )
  paramstructPP1.celltypes = celltypes;
  paramstructPP1.cellsubtypes = cellsubtypes;
  paramstructPP1.slidenames = slidenames;
  paramstructPP1.slideids = slideids;
end
...
if ~(nsim == 0) ;    %  Then do permutation test
  ...
  hold on ;
    ...
    if  ipval == 1  |  ipval == 3  ;    %  Add Gaussian density
